 ...
 */
class m160427_000000_retour_addHandledStats extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array(
            'handledByRetour' => ColumnType::Bool,
        );

        $this->_addColumnsAfter("retour_stats", $newColumns, "hitLastTime");
